  ...
  var_ids.forEach(function(id) {
    ...
    glob.sync(experimentJSON._dir + "/**/variation.json").forEach(
      function(dir) {
        ...
        client.getVariation(variationJSON.id).then(
          function(variation) {
          ...
          function() {
            console.log("Creating Variation:", variationJSON.description,
              "...");
            variationJSON.experiment_id = experimentJSON.id;
            return client.createVariation(variationJSON)
              .then(function(
                variation) {
      ...
      client.getExperiment(experimentJSON.id).then(
        ...
        function(error) {
          console.log("Creating Experiment:", experimentJSON.description,
            "...");
          experimentJSON.project_id = project.id
          return client.createExperimentC(experimentJSON)
            .then(
              function(experiment) {
